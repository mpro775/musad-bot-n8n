...
export class BotChatsController {
  ...
  @ApiResponse({
    ...
    description: 'تم حفظ الرسائل بنجاح',
  })
    ...
    schema: {
      ...
      properties: {
        rating: {
          ...
          enum: [0, 1],
          example: 1,
          description: '0 = سيء، 1 = جيد',
        },
        feedback: {
          type: 'string',
          example: 'الرد كان مفيداً',
  ...
  @Get()
  @ApiOperation({
    summary: 'قائمة بجميع المحادثات مع إمكانية التصفية والترقيم',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiQuery({
    name: 'q',
    required: false,
    description: 'بحث في نصوص المحادثات',
    example: 'مرحباً',
  })
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'تم استرجاع المحادثات بنجاح',
  })
  async list(
  ...
  @ApiQuery({
    name: 'limit',
    required: false,
    description: 'عدد الردود المطلوبة',
    example: '10',
  })
  @ApiResponse({
    status: HttpStatus.OK,
